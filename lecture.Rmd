...
Weekly schedule, lecture notes, R code and extra readings. We use [**R**](https://www.r-project.org/){target='_blank'} and [**RStudio**](https://www.rstudio.com/){target='_blank'} for lectures. 
